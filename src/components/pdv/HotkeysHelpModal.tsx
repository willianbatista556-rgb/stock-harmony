...
const shortcuts = [
  ...
  { key: 'F7', label: 'Suprimento', desc: 'Registrar entrada de dinheiro' },
  { key: 'F8', label: 'Sangria', desc: 'Registrar retirada de dinheiro' },
  { key: 'F9', label: 'Fechar Caixa', desc: 'Fechamento inteligente com conferência' },
