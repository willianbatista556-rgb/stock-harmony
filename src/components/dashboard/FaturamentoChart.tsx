...
interface Props {
  /** When true, renders without wrapping Card (for embedding inside CollapsibleSection) */
  embedded?: boolean;
}

export function FaturamentoChart({ embedded }: Props) {
  ...
  const content = isLoading ? (
    ...
    <ResponsiveContainer width="100%" height={embedded ? 200 : 220}>
      <AreaChart data={chartData} margin={{ top: 4, right: 4, left: -20, bottom: 0 }}>
        ...
        <XAxis dataKey="dia" tick={{ fontSize: 10 }} stroke="hsl(215 16% 47%)" />
